        ...
        <div>
        {
            ...
            ?
                ...
                <div className="profile-top">
                    <div className="profile-name">{employee.fullName.surname} {employee.fullName.name} {employee.fullName.lastName}</div>
                ...
                <div className="profile-nl">
                    ...
                    <div className="profile-nl-content">
                        ...
                        <div style={st1}>{employee.address.city}, вул. {employee.address.street}, {employee.address.zipCode}</div>
                    </div>
                </div>
            </div>
            :
